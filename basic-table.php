          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="basic-table.php?Results=1">Semester1</a></li>
                <li class="nav-item"> <a class="nav-link" href="basic-table.php?Results=2">Semester2</a></li>
                <li class="nav-item"> <a class="nav-link" href="basic-table.php?Results=3">Semester3</a></li>
                <li class="nav-item"> <a class="nav-link" href="basic-table.php?Results=4">Semester4</a></li>
              </ul>
            </div>
          </li>
