...
<br>
<div align="center">
  <?php echo @$_SESSION['comfirmuser'];?>
  <form class="login100-form validate-form p-b-33 p-t-5" name="form1" action="" method="post">
<br>
    <div class="wrap-input100 validate-input" data-validate = "Enter username">
      <input class="input100" type="hidden" name="username" placeholder="User name" value="<?php echo @$_SESSION['comfirmuser'];?>" >
