...
$list=$_POST['list'];
	...
	?>
      ...
      <?php }?>
        ...
        <td bgcolor="" style="height: 25px"><div align="center" class="style2 style2" style="font-weight: bold">Sit</div></td>
        <td bgcolor="" style="height: 25px"><div align="center" class="style2 style2" style="font-weight: bold">Pend</div></td>
        <td bgcolor="" style="height: 25px"><div align="center"><span class="style1"><span class="style1"><span class="style2"><span class="style2"></span></span></span></span></div></td>
      </tr>
	      <?php $n = $start; 
$msql=mysql_query("SELECT * FROM `studentsnm` WHERE dept ='$programme' && year='$year' &&`stat`='1'  && Withdrwan ='0' ORDER BY  `matno` ASC LIMIT $start,$list ");
if(!$msql){
die(mysql_error());
}
...
$n= $n+1;
 ?>
	      <tr>
	        <td bgcolor="#FFFFFF" style="font-size: small; width: 16px;"><span class="style5 style2"><?php echo $n;?></span></td>
	...
	die (mysql_error());
		...
		while ($res=mysql_fetch_array($sql)){?>
	        <td bgcolor="#FFFFFF" style="font-size: small"><div align="center" class="style5 style2"><?php echo $res['grade'];?></div></td>
		  <?php
		  // do not count the unit of unknown grades
		if (($res['grade']=="SICK")||($res['grade']=="ABSE")||($res['grade']=="PEND")||($res['grade']=="---")||($res['grade']=="EM")||($res['grade']=="PI")){
			 $res['unit']=0; 
			  } 
	...
	die (mysql_error());
		...
		if (($result['grade'] =="F")||($result['grade'] =="PEND")||($result['grade'] =="ABS")||($result['grade'] =="SICK")||($result['grade'] =="ABSE")||($result['grade'] =="EM")){
		$rem = $rem +1;
		}
		}
		  if ($semester <=5){
...
//}elseif(($ccgpa<=1.5)&&($semester>1)){
  ...
  <table width="100%" border="0">
    <tr>
      <td><span style="font-weight: bold">VIEW SPILL OVER RESULTS SUMMARY </span></td>
    </tr>
  </table>
</div>
