...
$all= mysql_query("SELECT * FROM studentsnm WHERE dept LIKE '$cid' && year ='$year' ORDER BY length(matno),matno", $db);
  ...
  $header = mysql_query("SELECT * FROM course WHERE programme LIKE '$cid' AND semester = '$smtr'",$db);
    ...
    ?>
<div align="center" style="font-weight:bold; text-transform:uppercase; font-size:36px;"> Niger State Polytechnic, Zungeru</div><br />
<div align="center" style="font-weight:bold; text-transform:uppercase; font-size:large;">Centre For Continueing Education and Training</div>
  ...
  <table  align='center'>
    <tr >
      <td align="center" style="font-weight: bold; color: #000000"><?php echo $s.$first;?> SEMESTER <?php echo " ".$ses;?><br />
      </td>
    </tr>
  </table>
  <p>&nbsp;</p>
  <div align="left"><?php echo "Course Code: ".$ccode;?></div><div align="right"><?php echo "Course Title: ".$ctitle;?></div>
  <table border="1" align="center" style="font-size:8px;">
    <tr >
      <td rowspan="2" id = 'page'><div align="center" style="font-size: x-small; font-weight: bold">
		  <span>S/N</span></div></td>
      <td rowspan="2" id = 'page'><div align="center" style="font-size: x-small; font-weight: bold"><span style="color: #000000; font-family: Arial, Helvetica, sans-serif;">MATRIC No.</span></div></td>
      <td rowspan="2" id = 'page'><div align="center" style="font-size: x-small; font-weight: bold"><span style="color: #000000; font-family: Arial, Helvetica, sans-serif;">NAMES</span></div></td>
    ...
    <tr  bgcolor = '' >
      <td id = 'page' style="height: 27px"><span style="font-size: x-small; font-weight: bold">100%</span></td>
      <td id = 'page' style="height: 27px"><span style="font-size: x-small; font-weight: bold">60%</span></td>
    </tr>
    <?php  
	$n = 0;
	...
	?>
    <tr bgcolor="#FFFFFF" >
      <td bgcolor="#FFFFFF" id = 'page'><span style="font-size: xx-small; font-weight: bold; color: #000000">
        <?php  echo $n;?></span></td>
      <td bgcolor="#FFFFFF" id = 'page2'><span style="font-size: x-small; font-weight: bold; color: #000000"><?php echo $res[2];?></span></td>
      <td bgcolor="#FFFFFF" id = 'page2'><span style="font-size: x-small; font-weight: bold; color: #000000">
        <?php  echo $res[1];?></span></td>
	...
	//  while( $cols = mysql_fetch_array($codes)){?><td bgcolor="#FFFFFF" id = 'page2'><span class="style5"></span> </td>
      <td bgcolor="#FFFFFF" id = 'page2'>&nbsp;</td>
      <td bgcolor="#FFFFFF" id = 'page2'>&nbsp;</td>
      <td bgcolor="#FFFFFF" id = 'page2'>&nbsp;</td>
      <td bgcolor="#FFFFFF" id = 'page2'>&nbsp;</td>
