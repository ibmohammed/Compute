...
$msq = mysql_query("SELECT *  FROM course WHERE programme LIKE '$course' AND semester = $sem && `sessions` LIKE '$sess'",$db) or die(mysql_error());
...
<font color="#000000">Print Result</font>

        <form action="resultsheetspgd.php" method="POST" name="grade" id="grade" target="_blank">
       <table>
<tr>
...
<tr>
<td align="left"><strong>MATRIC NO:</strong></td>
<td align="left"><strong>
