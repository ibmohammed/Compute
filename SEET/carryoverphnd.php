...
// keep old result
$oldres= mysql_query("INSERT INTO `consultdbsnw`.`coresult` (`name`, `matric_no`, `code`, `unit`, `score`, `grade`, `points`, `programme`, `semester`, `session`, `stat`) VALUES ('$name', '$matno', '$code1', '$unit1', '$score1', '$grade11', '$point', '$programme', '$semester', '$session', 'co','$year')")or die(mysql_error());
}
