...
if(isset($_POST['Submit2'])){
	...
	// Check if records already exist 
		...
		`matric_no` LIKE '$matricno' && `programme` LIKE '$programme' AND `semester`='$semester'");
...
$updt=mysql_query("UPDATE `consultdbsnw`.`studentsnm` SET `status` = '$semester' WHERE `studentsnm`.`matno` ='$matno' ");
	...
	<form action="" method="post" name="form1" id="form1" onsubmit="MM_validateForm('0','','R','0','','R');MM_validateForm('name','','R','matno','','R');return document.MM_returnValue">
...
<form action="" method="post" name="form2" id="form2" onsubmit="MM_validateForm('name','','R','matno','','R');MM_validateForm('name','','R','matno','','R');return document.MM_returnValue">
      <table border="0">
        <tr>
          <td ><span style="font-weight: bold">Name:</span></td>
          <td ><input name="name" type="text" id="name" value="<?php echo $row['names'];?>" size="40" readonly="1" />          </td>
        </tr>
        <tr>
          <td ><span style="font-weight: bold">MatricNo:</span></td>
          <td ><input name="matno" type="text" id="matno"  value="<?php echo $row['matno'];?>" readonly="1"/></td>
        </tr>
      </table>
        <table border="0">
          <tr>
