...
$list=$_POST['list'];
 ...
 die("empty fields not allowed");
		...
		$query= mysql_query("SELECT * FROM course WHERE 
...
dept ='$programme'&&  year='$year'  && Withdrwan ='0'
  ORDER BY length(matno),matno ASC") or die(mysql_error());
...
$n= $n+1;
 ...
 <tbody>
      <tr style="font-size:10pt">
		...
		programme='$programme' && semester='$semester' && matric_no='$matno'") or die (mysql_error());
...
//$ccgpa
 ...
 echo "<p style='page-break-before:always'></p>";
	...
	<form name = "propsal_form" action = "<?php echo ($_SERVER['PHP_SELF']);?>" method = "post">
<input type = "submit" name = "submit_doc" value = "Export as MS Word" Class = "input-button" />
</form>
<?php
