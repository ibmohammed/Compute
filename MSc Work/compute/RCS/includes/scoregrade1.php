...
if ($scores =='ABS'){
	...
	if ($scores>=0 and $scores <=39){
    	$grade11 = $f[$scores];
}
else
    if ($scores >= 40 and $scores <= 44){

        $grade11 =$d[$scores];
    }
    else
        if ($scores >= 45 and $scores <= 49){

            $grade11 =$cd[$scores];
        }
        else
            if ($scores >= 50 and $scores <= 54){

                $grade11 =$c[$scores];
            }
            else
                if ($scores >= 55 and $scores <= 59){

                    $grade11 =$bc[$scores];
                }
                else
                    if ($scores >= 60 and $scores <=64){

                        $grade11 =$b[$scores];
                    }
                    else
                        if ($scores >= 65 and $scores <=69){

                            $grade11 =$ab[$scores];
                        }
                        else
                            if ($scores >= 70 and $scores <=74){
