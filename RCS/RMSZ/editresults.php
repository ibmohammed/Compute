...
<table border="1"  style="width:600px; font-size:11px;">
	...
	//$programme=$_POST['programme'];
            ...
            <tr>
              ...
              <td ><a href="index.php?editres&id=<?php echo $row['sn']."&"."semester=".$semester."&"."programme="."$dept"."&"."year="."$year"."&"."session="."$session"."& Submit="."Submit". "& matno=".$row['matno'];?>" class="style1">EDIT</a></td>
            </tr><?php  }?>
      </table>
