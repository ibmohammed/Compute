...
<meta http-equiv="refresh" content="4; url='s_profile2.php?Ok'" />
...
Niger State Polytechnic, <br>Zungeru
...
<?php
if(@$_SESSION['comfirmstaff'] == True){
  echo $_SESSION['comfirmstaff'].':';
//  echo $_SESSION['stid'];
}
?>(Staff)</a>
 </div>
  ...
  <div class="w3-row">
    ...
    <div class="w3-col m3">
      ...
      if(isset($_GET['Ok']))
      {
        ...
        echo "<a href='logins.php' style='color:red'>Click here </a> if the Name, and Matric Number is not correct about you please verify your matric number and try login again  " ;
