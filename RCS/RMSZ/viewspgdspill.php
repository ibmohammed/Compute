...
$list=$_POST['list'];
	...
	?>
        ...
        <td rowspan="2" bgcolor="" style="width: 20px"><div align="center" class="style2" style="font-weight: bold">Matric_No</div></td>
      ...
      <?php }?>
        ...
        <td colspan="5" bgcolor=""><div align="center" class="style2" style="font-weight: bold">REMARKS</div></td>
	      ...
	      <tr>
	        <td bgcolor=""><div align="center" class="style2" style="font-weight: bold">cr</div></td>
        <td bgcolor=""><div align="center" class="style2" style="font-weight: bold">gp</div></td>
        <td bgcolor=""><div align="center" class="style2" style="font-weight: bold">gpa</div></td>
        <td bgcolor=""><div align="center" class="style2" style="font-weight: bold">cr</div></td>
        <td bgcolor=""><div align="center" class="style2" style="font-weight: bold">gp</div></td>
        <td bgcolor=""><div align="center" class="style2" style="font-weight: bold">gpa</div></td>
        <td bgcolor=""><div align="center" class="style2" style="font-weight: bold">cr</div></td>
        <td bgcolor=""><div align="center" class="style2" style="font-weight: bold">gp</div></td>
        <td bgcolor=""><div align="center" class="style2" style="font-weight: bold">gpa</div></td>
        <td bgcolor=""><div align="center" class="style2" style="font-weight: bold">co</div></td>
        <td bgcolor=""><div align="center" class="style2" style="font-weight: bold">EM</div></td>
        <td bgcolor=""><div align="center" class="style2" style="font-weight: bold">Sit</div></td>
        <td bgcolor=""><div align="center" class="style2" style="font-weight: bold">Pend</div></td>
        <td bgcolor=""><div align="center"><span class="style2"></span></div></td>
      </tr>
	      <?php $n = $start; 
...
$n= $n+1;
 ?>
	      <tr>
            ...
            <td bgcolor="#FFFFFF" style="font-size: small; width: 20px;"><div class="style2"><?php echo $col['matno'];?></div></td>
            <?php 
		$matno = $col['matno'];
